...
public class bipedYellowEnemy : EnemyCharacter, IEnemy
{
	...
	protected override void Update()
	{
		...
		//updates direction chage frequency value
		this.directionChangeFrequency = patrolPath.directionChangeFrequency;

		//upon reaching a destination selects another
		if (ai.reachedDestination && !movedObjectInSight)
		{
			NextPatrolPoint();
			reactionWait = true;
		}
